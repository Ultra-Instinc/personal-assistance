...
const Experience = () => {
    ...
    return ( 
    <div name='experience' className='bg-gradient-to-b from-gray-800 via-black to-black  lg:h-screen'>
        ...
        <div className='max-w-screen-lg mx-auto p-4 flex flex-col  justify-around  h-full text-white'>
            <div className='flex flex-col justify-center items-center overflow-hidden'>
                ...
                <span className=' opacity-90 absolute left-[580px] animate-bounce duration-1000 translate-x-[900px] top-0 bg-gradient-to-r via-red-800 to-red-900 h-[300px] w-[300px]'></span>
            </div>
